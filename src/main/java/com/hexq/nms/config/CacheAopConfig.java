package com.hexq.nms.config;

import com.hexq.nms.common.util.RedisUtil;
import com.hexq.nms.common.util.RspUtil;
import com.hexq.nms.common.interceptor.ReturnVerifyInterceptor;
...
public class CacheAopConfig {
     ...
     * 更新缓存切入点
     */
    @Pointcut("@annotation(com.hexq.nms.common.annotation.CacheRefresh)")
