package com.hexq.nms.common.util;

import com.hexq.nms.common.constant.ContentTypeEnum;
import com.hexq.nms.common.exception.MyException;
...
public class FileUploadUtil {
     ...
     * @return 文件名
     */
    public static String upload(MultipartFile file, String modelFilePath, boolean uuidFileName) throws IOException {
    ...
    public static List<String> upload(List<MultipartFile> file, String modelFilePath, boolean uuidFileName) throws IOException {
        List<String> nameLs = new LinkedList<>();
        for (MultipartFile multipartFile : file) {
            String fileName = upload(multipartFile, modelFilePath, uuidFileName);
            nameLs.add(fileName);
        }
        return nameLs;
    }
